...
async def update_bot(event, repo, ups_rem, ac_br):
    ...
    sandy = await event.edit(f"**- im Update**")
    await event.client.reload(sandy)


async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is None:
        return await event.edit(f"Hayder ,\n **•─────────────────•**\n** ⪼ لم تقـم بوضـع مربـع فـار HEROKU_API_KEY اثنـاء التنصيب وهـذا خطـأ .. قم بضبـط المتغيـر أولاً لتحديث بوت ريـثون ..؟!**", link_preview=False)
    heroku = heroku3.from_key(HEROKU_API_KEY)
    heroku_applications = heroku.apps()
    if HEROKU_APP_NAME is None:
        await event.edit(f"Hayder ,\n **•─────────────────•**\n** ⪼ لم تقـم بوضـع مربـع فـار HEROKU_APP_NAME اثنـاء التنصيب وهـذا خطـأ .. قم بضبـط المتغيـر أولاً لتحديث بوت ريـثون ..؟!**", link_preview=False)
        repo.__del__()
        return
    heroku_app = next(
...
async def upstream(event):
    ...
    if conf == "الان":
        await event.edit(f"Hayder ,\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريـثون .. انتظـر . . .🌐**")
        await asyncio.sleep(1)
        await event.edit("Hayder ,\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريـثون .. انتظـر . . .🌐**\n\n%10 ▬▭▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("Hayder ,\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريـثون .. انتظـر . . .🌐**\n\n%20 ▬▬▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("Hayder ,\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريـثون .. انتظـر . . .🌐**\n\n%30 ▬▬▬▭▭▭▭▭▭▭")
...
async def upstream(event):
    ...
    off_repo = "https://github.com/hhvhh/nekopack"
    os.chdir("/app")
    try:
        txt = (
